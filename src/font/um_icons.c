 ...
 * Size: 48 px
 * Bpp: 4
 * Opts: --font MaterialIcons-Regular.ttf --range 0xe8bf,0xe1bb,0xe1e2,0xe623,0xe554,0xe8b8,0xe88e,0xe887 --size 48 --bpp 4 --no-compress --lv-font-name um_icons -o um_icons.c --format lvgl
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 800, .adv_w = 768, .box_w = 40, .box_h = 38, .ofs_x = 4, .ofs_y = 4},
    {.bitmap_index = 1560, .adv_w = 768, .box_w = 40, .box_h = 34, .ofs_x = 4, .ofs_y = 7},
