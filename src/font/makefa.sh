...
# Size 48 — menu tile icons (kept for compatibility)
...
# Size 80 — large menu tile icons
lv_font_conv --font "$FONT" --range "$RANGES" \
  --size 80 --bpp 4 --no-compress --lv-font-name um_icons_80 \
  -o um_icons_80.c --format lvgl
sed -i '' "$PATCH" um_icons_80.c
