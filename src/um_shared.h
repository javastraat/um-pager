...
#define UM_SYMBOL_WIFI     "\xEE\x98\xBE"  // U+E63E wifi
#define UM_SYMBOL_MESH     "\xEE\x87\xA2"  // U+E1E2 wifi (used as mesh icon)
...
#define UM_SYMBOL_HOME      "\xEE\xA2\x8A"  // U+E88A home
#define UM_SYMBOL_ENVELOPE  "\xEE\x95\x94"  // U+E554 mail (mailbox icon)
#define UM_SYMBOL_SEND      "\xEE\x85\xA3"  // U+E163 send
#define UM_SYMBOL_WARNING        "\xEE\x80\x82"  // U+E002 warning
